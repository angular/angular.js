 ...
 *   usually the resource is assigned to a model which then renders it. Having an empty object
 *   results in no rendering, once the data arrives from the server then the object is populated
 *   with the data and the view automatically re-renders itself showing the new data. This means
 *   that in most case one never has to write a callback function for the action methods.
 *
