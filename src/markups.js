 ...
 * </pre>
 *
 * the HTML specs do not require browsers to preserve the special attributes such as disabled. (The presence of them means true and absence means false)
 ...
 *
 * @description
 * the HTML specs do not require browsers to preserve the special attributes such as checked. (The presence of them means true and absence means false)
 * This prevents the angular compiler from correctly retrieving the binding expression.
 ...
 *
 * @description
 * the HTML specs do not require browsers to preserve the special attributes such as multiple. (The presence of them means true and absence means false)
 * This prevents the angular compiler from correctly retrieving the binding expression.
 ...
 *
 * @description
 * the HTML specs do not require browsers to preserve the special attributes such as readonly. (The presence of them means true and absence means false)
 * This prevents the angular compiler from correctly retrieving the binding expression.
...
*
* @description
* the HTML specs do not require browsers to preserve the special attributes such as selected. (The presence of them means true and absence means false)
* This prevents the angular compiler from correctly retrieving the binding expression.
