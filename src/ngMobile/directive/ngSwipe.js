 ...
 *  `swipedown` to $mobile
 */
ngMobile.factory('$mobileSwipe', ['$mobile', function($mobile) {
  $mobile.register({
    name: 'swipe',
    index: 40,
    defaults: {
 ...
 */
ngMobile.directive('ngSwipe', ['$parse', '$mobileSwipe', function($parse, $mobile) {
 ...
 */
ngMobile.directive('ngSwipeRight', ['$parse', '$mobileSwipe', function($parse, $mobile) {
  return function(scope, element, attr) {
 ...
 */
ngMobile.directive('ngSwipeLeft', ['$parse', '$mobileSwipe', function($parse, $mobile) {
  return function(scope, element, attr) {
 ...
 */
ngMobile.directive('ngSwipeUp', ['$parse', '$mobileSwipe', function($parse, $mobile) {
  return function(scope, element, attr) {
 ...
 */
ngMobile.directive('ngSwipeDown', ['$parse', '$mobileSwipe', function($parse, $mobile) {
  return function(scope, element, attr) {
