 ...
 * reason angular provides `<ng:form>` alias which behaves identical to `<form>` but allows nesting.
 *
 *
 * @example
    <doc:example>
      <doc:source>
       ...
       <div ng:controller="Cntl">
         <form name="myForm">
           ...
           <span style="color: red;" ng:show="myForm.text.$error.REQUIRED">Required!</span>
         </form>
         <tt>text = {{text}}</tt><br/>
