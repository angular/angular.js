...
angularWidget('select', function (element){
  ...
  return element.attr('ng:model') && annotate('$formFactory', function($formFactory, selectElement){
    var modelScope = this,
        ...
        widget = form.$createWidget(this, modelExp, selectElement.attr('ng:change'),
            selectElement.attr('name'),  optionsExp ? Options : (multiple ? Multiple : Single));

    selectElement.bind('$destroy', function(){ widget.$destroy(); });

    widget.$pristine = !(widget.$dirty = false);

    watchElementProperty(widget, 'required', selectElement);
    watchElementProperty(widget, 'readonly', selectElement);
    watchElementProperty(widget, 'disabled', selectElement);
    ...
    function Multiple(){
      ...
      selectElement.bind('change', bind(widget, widget.$apply, function (){
        var array = [];
        forEach(selectElement.children(), function(option){
          if (option.selected) {
