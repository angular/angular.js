 ...
 * number. Directives with lower numerical `priority` are compiled first. Pre-link functions
 * are also run in contra-priority order, but post-link functions are run in reverse order. The order
