 ...
 * with your own using the `track by` expression. When a `track by` expression is present, its
 * return value is used to track the items instead of the items themselves:
 *
 * For example, you may track items by the index of each item in the collection, using the
 * special property `$index`:
 * ```html
 *    <ul>
 ...
 * ```html
 *    <ul>
 *      <li ng-repeat="n in [42, 42, 43, 43] track by myTrackingFunction(n)">
 *        {{ n }}
 *      </li>
 *    </ul>
 * ```
 ...
 * ```html
 *    <ul>
 *      <li ng-repeat="obj in coll track by $id(obj)">
 *        {{ obj }}
 *      </li>
 *    </ul>
 * ```
