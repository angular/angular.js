...
var EMAIL_REGEXP = /^(?=.{1,254}$)(?=.{1,64}@)[-!#$%&'*+/0-9=?A-Z^_`\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEFaa-z{|}~]+(\.[-!#$%&'*+/0-9=?A-Z^_`\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEFaa-z{|}~]+)*@[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEFaA-Za-z0-9]([\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEFaA-Za-z0-9-]{0,61}[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEFaA-Za-z0-9])?(\.[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEFaA-Za-z0-9]([\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEFaA-Za-z0-9-]{0,61}[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEFaA-Za-z0-9])?)*$/;
