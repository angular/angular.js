...
function validityChanged(ctrl, element) {
  return !equals(ctrl.$validityState, element.prop('validity'));
}
...
function textInputType(scope, element, attr, ctrl, $sniffer, $browser, validity) {
  ...
  var listener = function() {
    ...
    if (ctrl.$viewValue !== value || (validity && validityChanged(ctrl, element))) {
...
function numberInputType(scope, element, attr, ctrl, $sniffer, $browser) {
  textInputType(scope, element, attr, ctrl, $sniffer, $browser, true);
