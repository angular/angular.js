 ...
 * $animate temporarily blocking transitions using `none 0s` in order to allow the setup CSS class
 * (the `-add` or `-remove` class) to be applied without triggering an animation. However, as of **1.3**,
 * This workaround has been removed with ngAnimate and all non-ngAnimate CSS class transitions
 * are compatible with ngAnimate.
 *
