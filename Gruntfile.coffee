files = require('./angularFiles').files
util = require './lib/grunt/utils.js'
...
module.exports = (grunt) ->
  ...
  NG_VERSION = util.getVersion()
  dist = "angular-#{NG_VERSION.full}"
          ...
          middleware: (connect, options) ->
            return [
              (req, resp, next) ->
                ...
                resp.setHeader('Cache-control', 'public, max-age=3600') if req.method is 'GET'
                next()
