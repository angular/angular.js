...
module.exports = function(grunt) {
  ...
  grunt.registerTask('log-bower-starting', 'Logs when Bower is about to start.', function () {
    grunt.log.writeln('[DEBUG] Starting shell:bower... ');
  });

  grunt.registerTask('log-bower-finished', 'Logs when Bower is finished.', function () {
    grunt.log.writeln('[DEBUG] shell:bower completed successfully.');
  });
};
