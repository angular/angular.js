...
var minerrUtils = require('../minerr/utils.js');
...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('strip-errors', 'Strip error messages', function () {
    minerrUtils.stripErrors(this.target, grunt.config('NG_VERSION'), this.data);
  });

  grunt.registerTask('post-minify', 'Clean up build cruft', function () {
    grunt.file.expand('build/*.strip.js').forEach(function (file) {
