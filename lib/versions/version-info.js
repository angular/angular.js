...
var getCdnVersion = function(previousVersions) {
  return _(previousVersions || getPreviousVersions())
    .filter(function(tag) {
 ...
 */
var getSnapshotVersion = function(previousVersions) {
  var version = _(previousVersions || getPreviousVersions())
    .filter(function(tag) {
      return semver.satisfies(tag, currentPackage.branchVersion);
    })
    .last();
...
var getCurrentVersion = function(previousVersions) {
  return getTaggedVersion(previousVersions) || getSnapshotVersion(previousVersions);
};
...
exports.getCdnVersion = getCdnVersion;
