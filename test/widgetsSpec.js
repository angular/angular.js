...
describe("widget", function() {
  ...
  describe('@ng:repeat', inject(function($rootScope) {
    ...
    it('should expose iterator position as $position when iterating over arrays', inject(function($rootScope) {
      var element = angular.compile(
        '<ul>' +
    ...
    it('should expose iterator position as $position when iterating over objects', inject(function($rootScope) {
      var element = angular.compile(
        '<ul>' +
          '<li ng:repeat="(key, val) in items" ng:bind="key + \':\' + val + \':\' + $position + \'|\'"></li>' +
        '</ul>')($rootScope);
