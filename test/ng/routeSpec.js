...
describe('$route', function() {
  ...
  describe('events', function() {
    ...
    it('should fire $failedRouteChange event on resolution error', function() {
      var deferA;
      ...
      inject(function($location, $route, $rootScope) {
        ...
        $rootScope.$on('$failedRouteChange', function(e, n, l, reason) { log += 'failed(' + reason + ');'; });
    ...
    it('should drop in progress route change when new route change occurs and old fails', function() {
      ...
      inject(function($route, $httpBackend, $location, $rootScope) {
        var log = '';
        $rootScope.$on('$failedRouteChange', function(e, next, last, error) {
