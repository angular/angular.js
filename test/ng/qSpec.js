...
describe('q', function() {
  ...
  multiDescribe(['$Q', '$q.defer'], function(description) {
    var resolve, reject, resolve2, reject2, createPromise;
    ...
    if (description === '$Q') {
      ...
      createPromise = function() {
        ...
        if (resolve === null) {
          ...
          resolve2 = deferred.resolve;
          reject2 = deferred.reject;
        }
