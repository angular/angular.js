describe('jqLite', function(){
  ...
  describe('attr', function(){
    it('shoul read wirite and remove attr', function(){
      ...
      expect(jqLite(a).attr('prop')).toEqual(undefined);
      expect(jqLite(b).attr('prop')).toEqual(undefined);
    });
  });
  ...
  describe('css', function(){
    it('should set and read css', function(){
      ...
      expect(jqLite(a).css('prop')).toEqual(undefined);
      expect(jqLite(b).css('prop')).toEqual(undefined);
    });
  });
  ...
  describe('replaceWith', function(){
    it('should replaceWith', function(){
      var root = jqLite('<block>').html('before-<div></div>after');
  ...
  describe('children', function(){
    it('should select non-text children', function(){
      var root = jqLite('<block>').html('before-<div></div>after-<span></span>');
      var div = root.find('div');
  ...
  describe('append', function(){
    it('should append', function(){
      ...
      expect(root.html()).toEqual('<span>abc</span>');
    });
  ...
  describe('after', function(){
    it('should after', function(){
      ...
      var span = root.find('span');
      expect(span.after('<div></div><b></b>')).toEqual(span);
      expect(root.html()).toEqual('<span></span><div></div><b></b>');
    });
    it('should allow taking text', function(){
      var root = jqLite('<div><span></span></div>');
      var span = root.find('span');
      span.after('abc');
      expect(root.html()).toEqual('<span></span>abc');
    });
  });
