describe('HTML', function(){
  ...
  xit('should handle improper html2', function(){
  ...
  describe('htmlSanitizerWriter', function(){
    ...
    describe('javascript URL attribute', function(){
      ...
      it('should ignore hex encodede javascript:', function(){
      ...
      it('should ignore hex encodede whitespace javascript:', function(){
