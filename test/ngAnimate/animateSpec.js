...
describe("ngAnimate", function() {
    ...
    describe("$animate", function() {
      ...
      describe("Callbacks", function() {
        ...
        it('should fire DOM callbacks on the element being animated',
          ...
          expect(steps.shift()).toEqual(['before', 'klass', 'addClass']);
          expect(steps.shift()).toEqual(['after', 'klass', 'addClass']);
  ...
  //  });
    ...
    it("should properly add and remove CSS classes when multiple classes are applied",
      ...
      $rootScope.className = '';
      $rootScope.$digest();
      //intentionally avoiding the flush operation
