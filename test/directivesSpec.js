...
describe("directive", function() {
  ...
  describe('ng:style', function() {
    ...
    it('should preserve and remove previous style', inject(function($rootScope) {
      var element = angular.compile('<div style="height: 10px;" ng:style="myStyle"></div>')($rootScope);
      $rootScope.$digest();
  ...
  it('should silently ignore undefined ng:style', inject(function($rootScope) {
    var element = angular.compile('<div ng:style="myStyle"></div>')($rootScope);
    $rootScope.$digest();
    expect(element.hasClass('ng-exception')).toBeFalsy();
  }));
