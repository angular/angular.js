describe("markups", function(){
  ...
  it('should ParseTextWithNoBindings', function(){
  ...
  it('should ParseEmptyText', function(){
  ...
  it('should ParseInnerBinding', function(){
  ...
  it('should ParseEndingBinding', function(){
  ...
  it('should ParseBeggingBinding', function(){
  ...
  it('should ParseLoanBinding', function(){
  ...
  it('should ParseTwoBindings', function(){
    var parts = parseBindings("{{b}}{{c}}");
    assertEquals(parts.length, 2);
    assertEquals(parts[0], "{{b}}");
    assertEquals(binding(parts[0]), "b");
  ...
  it('should ParseTwoBindingsWithTextInMiddle', function(){
  ...
  it('should ParseMultiline', function(){
