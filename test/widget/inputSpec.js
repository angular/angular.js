...
describe('widget: input', function(){
  ...
  describe("input", function(){
    ...
    it("should process required", function(){
      ...
      expect(scope.$service('$formFactory').root.p.$required).toBe(true);
  ...
  describe('scope declaration', function(){
    it('should read the declaration from scope', function(){
      ...
      element = angular.element('<input type="scope:my_type" ng:model="abc">');
      scope = angular.scope();
  ...
  describe('text subtypes', function(){
    ...
    itShouldVerify('regexp inline',
        ['', '000-00-0000', '123-45-6789'],
        ['x000-00-0000x', 'x'],
        {'ng:regexp':'/^\\d\\d\\d-\\d\\d-\\d\\d\\d\\d$/'});

    itShouldVerify('regexp from scope',
        ['', '000-00-0000', '123-45-6789'],
        ['x000-00-0000x', 'x'],
        {'ng:regexp':'regexp'}, function(scope){
