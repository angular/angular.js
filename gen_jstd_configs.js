/* This file reads in list of files from files.js and generate various jstd config files */
...
function combine(load, exclude) {
  ...
  //Replace placeholders for src and scenario lists before returning
  return fileList.replace(/angularScenario/g, angularScenario).replace(/angularSrc/g, angularSrc);
}
